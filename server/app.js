...
app.get('/cats/:id/toys', async (req, res, next) => {
    ...
    const catToysAggregateData = await Cat.findByPk(req.params.id, {
        ...
        attributes: [
            ...
            // Your code here
            [
                sequelize.fn("COUNT", sequelize.col("Toys.id")),
                "toyCount"
            ],
            ...
            // Your code here
            [
                sequelize.fn("AVG", sequelize.col("Toys.price")),
                "averageToyPrice"
            ],
...
app.get('/data-summary', async (req, res, next) => {
    ...
    const toySummary = await Toy.findAll({
        attributes: {
            exclude: ['id', 'name', 'color', 'price', 'createdAt', 'updatedAt'],
            include: [
                [
    ...
    res.json({
        ...
        totalNumberOfToys: totalNumberOfToys,
